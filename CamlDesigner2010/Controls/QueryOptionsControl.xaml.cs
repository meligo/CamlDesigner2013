// ----------------------------------------------------------------------
// <copyright file="QueryOptionsControl.xaml.cs" company="Biwug">
...
namespace CamlDesigner.Controls
{
    ...
    public partial class QueryOptionsControl : UserControl
    {
        ...
        public QueryOptionsControl()
        {
            ...
            if (App.ConnectionType == BPoint.SharePoint.Common.Enumerations.ConnectionType.ClientObjectModelForDotnet)
            {
        ...
        private void PopulateScopeComboBox()
        {
            ...
            List<BPoint.SharePoint.Common.Enumerations.SiteDataQueryScope> comboList = new List<BPoint.SharePoint.Common.Enumerations.SiteDataQueryScope>();

            comboList.Add(new BPoint.SharePoint.Common.Enumerations.SiteDataQueryScope("Site collection", "SiteCollection"));
            comboList.Add(new BPoint.SharePoint.Common.Enumerations.SiteDataQueryScope("Site", "Site"));
            comboList.Add(new BPoint.SharePoint.Common.Enumerations.SiteDataQueryScope("Site and sub sites", "Recursive"));
