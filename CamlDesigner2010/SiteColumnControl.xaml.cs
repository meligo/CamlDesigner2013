// ----------------------------------------------------------------------
// <copyright file="SiteColumnControl.xaml.cs" company="Biwug">
    ...
    public partial class SiteColumnControl : UserControl
    {
        ...
        private void GenerateButton_Click(object sender, RoutedEventArgs e)
        {
            if (DataTypeComboBox.SelectedItem != null)
            {
                ...
                string datatype = BPoint.SharePoint.Common.UtilityFunctionsCAML.GetCAMLDataType(selectedDataType);
                ...
                {
                    case "Single line of text":
                        camlstring = BPoint.SharePoint.Common.Builder.GenerateTextSiteColumn(
