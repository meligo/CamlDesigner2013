...
namespace BPoint.SharePoint.Common
{
            ...
            switch (whereField.Field.DataType)
            {
                ...
                case "TaxonomyFieldTypeMulti":
                    ...
                    if (whereField.Values[0] != null)
                    {
                        ...
                        else if (whereField.Values[0] is BPoint.SharePoint.Objects.TaxonomyValue)
                        {
                            if (whereField.ByLookupId)
                                value = ((BPoint.SharePoint.Objects.TaxonomyValue)whereField.Values[0]).ID.ToString();
                            else
                                value = ((BPoint.SharePoint.Objects.TaxonomyValue)whereField.Values[0]).Value;
                        }
        ...
        private static string GetCamlFromMultipleValues(WhereField whereField)
        {
            ...
            if (whereField.Values != null)
            {
                switch (whereField.Field.DataType)
                {
                    ...
                    case "DateTime":
                        // TODO: check ivm utd date
                        if (whereField.OptionalDateParameter == BPoint.SharePoint.Common.Enumerations.OptionalDateParameters.SpecificDate)
                        {
