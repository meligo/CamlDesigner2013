...
namespace CamlDesigner2013.Controls
{
    ...
    public partial class FieldControl : UserControl
    {
        ...
        private void CreateControlsForTaxonomyField()
        {
            ...
            if (App.GeneralInformation.ConnectionType == BPoint.SharePoint.Common.Enumerations.ApiConnectionType.WebServices
                || (App.GeneralInformation.ConnectionType == BPoint.SharePoint.Common.Enumerations.ApiConnectionType.ClientObjectModel
                    && App.GeneralInformation.SharePointVersion == BPoint.SharePoint.Common.Enumerations.SharePointVersions.SP2010))
            {
                // Do nothing
            }
            else
