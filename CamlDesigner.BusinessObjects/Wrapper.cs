...
using BPoint.SharePoint.DataAccess;
using BPoint.SharePoint.DataAccess.SP2013;
...
namespace CAMLDesigner.BusinessObjects
{
    public class Wrapper
    {
        ...
        private BPoint.SharePoint.DataAccess.SP2013.ClientOMHelper sp2013ClientOmHelper = null;
        private BPoint.SharePoint.DataAccess.WebServiceHelper webServiceHelper = null;
        ...
        private Enumerations.SharePointVersions versionType;
        ...
        public Wrapper(string url, Enumerations.ApiConnectionType connectionType, Enumerations.SharePointVersions versionType)
        {
            this.sharePointUrl = url;
            // this.sharePointVersion = sharePointVersion;
            this.ConnectionType = connectionType;
        ...
        public Wrapper(string url, Enumerations.ApiConnectionType connectionType, Enumerations.SharePointVersions versionType,
            ...
            : this(url, connectionType, versionType)
        {
        ...
        public Enumerations.SharePointVersions VersionType
        {
        ...
        private ClientOMHelper O365ClientOMHelper
        {
            get
            {
                if (sp2013ClientOmHelper == null && !string.IsNullOrEmpty(sharePointUrl))
                {
                    sp2013ClientOmHelper = new ClientOMHelper(sharePointUrl, true);
                }

                return sp2013ClientOmHelper;
            }
        }

        private ClientOMHelper SP2013ClientOMHelper
        {
            get
            {
                if (sp2013ClientOmHelper == null && !string.IsNullOrEmpty(sharePointUrl))
                {
                    ...
                    sp2013ClientOmHelper = new ClientOMHelper(sharePointUrl, null, true, username, password);
                }
        ...
        public Web GetWeb(string webUrl)
        {
            ...
            switch (connectionType)
            {
                ...
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    switch (VersionType)
                    {
                        case Enumerations.SharePointVersions.SP2007:
                            //CSOM doesn't exist for SP 2007
                            break;
                        case Enumerations.SharePointVersions.SP2010:
                            web = SP2013ClientOMHelper.GetWeb(webUrl);
                            break;
                        case Enumerations.SharePointVersions.SP2013:
                            web = SP2013ClientOMHelper.GetWeb(webUrl);
                            break;
                        case Enumerations.SharePointVersions.SP2016:
                            web = SP2013ClientOMHelper.GetWeb(webUrl);
                            break;
                        case Enumerations.SharePointVersions.O365:
                            web = O365ClientOMHelper.GetWeb(webUrl);
                            break;
                        default:
                            break;
                    }
                ...
                case Enumerations.ApiConnectionType.WebServices:
                    // check if the url connects to SharePoint online -  no longer neede 
                    switch (VersionType)
                    {
                        case Enumerations.SharePointVersions.SP2007:
        ...
        public List<Web> GetWebs(string webUrl)
        {
            ...
            switch (connectionType)
            {
                ...
                //    break;
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    webs = SP2013ClientOMHelper.GetWebs(webUrl);
                    break;
                case Enumerations.ApiConnectionType.WebServices:
        ...
        public List<List> GetLists()
        {
            ...
            switch (connectionType)
            {
                ...
                //    break;
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    lists = SP2013ClientOMHelper.GetLists(this.sharePointUrl);
                    break;
                case Enumerations.ApiConnectionType.WebServices:
        ...
        public List<Field> GetFields(string listName, bool excludeHiddenFields, bool isCalendar)
        {
            ...
            switch (connectionType)
            {
                ...
                //    break;
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    fields = SP2013ClientOMHelper.GetFields(listName, excludeHiddenFields);
                    break;
                case Enumerations.ApiConnectionType.WebServices:
        ...
        public List<GroupValue> GetGroups()
        {
            ...
            switch (connectionType)
            {
                ...
                //    break;
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    groups = SP2013ClientOMHelper.GetGroups();
                    break;
                case Enumerations.ApiConnectionType.WebServices:
        ...
        public List<LookupValue> GetLookupValues(string listGuid, string showField, Guid lookupWebId)
        {
            ...
            switch (connectionType)
            {
                ...
                //    break;
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    values = SP2013ClientOMHelper.GetLookupValues(listGuid, showField, lookupWebId);
                    break;
                case Enumerations.ApiConnectionType.WebServices:
        ...
        public TaxonomyValue GetTaxonomyValue(Guid termStoreId, Guid termSetId, string input)
        {
            ...
            switch (connectionType)
            {
                ...
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    value = SP2013ClientOMHelper.GetTaxonomyValue(termStoreId, termSetId, input);
                    break;
        ...
        public List<TaxonomyValue> GetTaxonomyValues(Guid termStoreId, Guid termSetId)
        {
            ...
            switch (connectionType)
            {
                ...
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    values = SP2013ClientOMHelper.GetTaxonomyValues(termStoreId, termSetId);
                    break;
        ...
        public List<string> GetSiteColumnGroups()
        {
            ...
            switch (connectionType)
            {
                case Enumerations.ApiConnectionType.ServerObjectModel:
                    ...
                    break;
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    //fields = SP2013ClientOMHelper.GetSiteColumnGroups();
                    break;
                case Enumerations.ApiConnectionType.WebServices:
        ...
        public DataTable ExecuteQuery(string listName, MainObject mainobject, Enumerations.QueryType queryType)
        {
            ...
            switch (connectionType)
            {
                ...
                //    break;
                case Enumerations.ApiConnectionType.ClientObjectModel:
                    resultTable = SP2013ClientOMHelper.ExecuteQuery(listName, mainobject, queryType);
                    break;
                case Enumerations.ApiConnectionType.WebServices:
