...
namespace BPoint.SharePoint.DataAccess
{
    public class TaxonomyWebServiceHelper
    {
        ...
        private BPoint.DataAccess.WebServices.TaxonomyWebService.Taxonomywebservice taxonomyWebService = null;
        ...
        public BPoint.DataAccess.WebServices.TaxonomyWebService.Taxonomywebservice TaxonomyWebService
        {
            get
            {
        ...
        private void InitializeWebService(string url)
        {
            ...
            taxonomyWebService = new BPoint.DataAccess.WebServices.TaxonomyWebService.Taxonomywebservice();
