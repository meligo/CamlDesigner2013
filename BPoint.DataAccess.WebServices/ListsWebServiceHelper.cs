...
namespace BPoint.SharePoint.DataAccess
{
    public class ListsWebServiceHelper
    {
        ...
        private BPoint.DataAccess.WebServices.ListsWebService.Lists listsWebService = null;
        ...
        public BPoint.DataAccess.WebServices.ListsWebService.Lists ListsWebService
        {
            get
            {
        ...
        public List<LookupValue> GetLookupValues(string webUrl, string listGuid, string showField)
        {
            ...
            if (showField == "FileRef")
            {
                ...
                queryNode.InnerXml += BPoint.Common.CAMLConstants.FolderQuery;

                queryOptionsNode = xmlDoc.CreateElement(Enumerations.QueryOptions.Tag);
                queryOptionsNode.InnerXml += BPoint.Common.CAMLConstants.QueryOptions.RecursiveAll;
            }
        ...
        private void InitializeWebService(string url)
        {
            ...
            listsWebService = new BPoint.DataAccess.WebServices.ListsWebService.Lists();
