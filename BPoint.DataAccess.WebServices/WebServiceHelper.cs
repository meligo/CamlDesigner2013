    ...
    public class WebServiceHelper
    {
            ...
            get
            {
                if (listsWebServiceHelper == null)
                {
                    if (useDefaultCredentials)
                        listsWebServiceHelper = new DataAccess.ListsWebServiceHelper(sharePointUrl);
                    else
                        listsWebServiceHelper = new DataAccess.ListsWebServiceHelper(sharePointUrl, username, password, domain);
                }
        ...
        public WebsWebServiceHelper WebsWebServiceHelper
        {
            get
            {
                ...
                {
                    if (useDefaultCredentials)
                        websWebServiceHelper = new DataAccess.WebsWebServiceHelper(sharePointUrl);
                    else
                        websWebServiceHelper = new DataAccess.WebsWebServiceHelper(sharePointUrl, username, password, domain);
                }
        ...
        public ViewsWebServiceHelper ViewsWebServiceHelper
        {
            get
            {
                ...
                {
                    if (useDefaultCredentials)
                        viewsWebServiceHelper = new DataAccess.ViewsWebServiceHelper(sharePointUrl);
                    else
                        viewsWebServiceHelper = new DataAccess.ViewsWebServiceHelper(sharePointUrl, username, password, domain);
                }
        ...
        public TaxonomyWebServiceHelper TaxonomyWebServiceHelper
        {
            get
            {
                ...
                {
                    if (useDefaultCredentials)
                        taxonomyWebServiceHelper = new DataAccess.TaxonomyWebServiceHelper(sharePointUrl);
                    else
                        taxonomyWebServiceHelper = new DataAccess.TaxonomyWebServiceHelper(sharePointUrl, username, password, domain);
                }
        ...
        public SiteDataWebServiceHelper SiteDataWebServiceHelper
        {
            get
            {
                ...
                {
                    if (useDefaultCredentials)
                        siteDataWebServiceHelper = new DataAccess.SiteDataWebServiceHelper(sharePointUrl);
                    else
                        siteDataWebServiceHelper = new DataAccess.SiteDataWebServiceHelper(sharePointUrl, username, password, domain);
                }
        ...
        public UserGroupWebServiceHelper UserGroupWebServiceHelper
        {
            get
            {
                ...
                {
                    if (useDefaultCredentials)
                        usergroupWebServiceHelper = new DataAccess.UserGroupWebServiceHelper(sharePointUrl);
                    else
                        usergroupWebServiceHelper = new DataAccess.UserGroupWebServiceHelper(sharePointUrl, username, password, domain);
                }
