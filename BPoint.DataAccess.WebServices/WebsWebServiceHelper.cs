...
namespace BPoint.SharePoint.DataAccess
{
    public class WebsWebServiceHelper
    {
        ...
        private BPoint.DataAccess.WebServices.WebsWebService.Webs websWebService = null;
        ...
        public BPoint.DataAccess.WebServices.WebsWebService.Webs WebsWebService
        {
            get
            {
        ...
        private void InitializeWebService(string url)
        {
            ...
            websWebService = new BPoint.DataAccess.WebServices.WebsWebService.Webs();
