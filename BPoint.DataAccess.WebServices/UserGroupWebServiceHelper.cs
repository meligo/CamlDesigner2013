...
namespace BPoint.SharePoint.DataAccess
{
    public class UserGroupWebServiceHelper
    {
        ...
        private BPoint.DataAccess.WebServices.UserGroupWebService.UserGroup userGroupWebService = null;
        ...
        public BPoint.DataAccess.WebServices.UserGroupWebService.UserGroup UserGroupWebService
        {
            get
            {
        ...
        private void InitializeWebService(string url)
        {
            ...
            userGroupWebService = new BPoint.DataAccess.WebServices.UserGroupWebService.UserGroup();
