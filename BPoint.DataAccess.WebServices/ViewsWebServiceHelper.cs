...
using System.Text;
using System.Xml;
using BPoint.DataAccess.WebServices;
...
namespace BPoint.SharePoint.DataAccess
{
    public class ViewsWebServiceHelper
    {
        ...
        private BPoint.DataAccess.WebServices.ViewsWebService.Views viewsWebService = null;
        ...
        public BPoint.DataAccess.WebServices.ViewsWebService.Views ViewsWebService
        {
            get
            {
        ...
        private void InitializeWebService(string url)
        {
            ...
            viewsWebService = new BPoint.DataAccess.WebServices.ViewsWebService.Views();
