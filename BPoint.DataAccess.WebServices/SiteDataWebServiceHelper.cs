...
namespace BPoint.SharePoint.DataAccess
{
    public class SiteDataWebServiceHelper
    {
        ...
        private BPoint.DataAccess.WebServices.SiteDataWebService.SiteData siteDataWebService = null;
        ...
        public BPoint.DataAccess.WebServices.SiteDataWebService.SiteData SiteDataWebService
        {
            get
            {
        ...
        private void InitializeWebService(string url)
        {
            ...
            siteDataWebService = new BPoint.DataAccess.WebServices.SiteDataWebService.SiteData();
