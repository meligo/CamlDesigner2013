...
namespace CamlDesigner2013.PreviewControl
{
    public class Host : MarshalByRefObject, IDisposable
    {
        ...
        public Host(string filename, string baseDirectory)
        {
        ...
        void ControlLoaded(object sender, RoutedEventArgs e)
        {
            ...
            wb.Loaded += WbLoaded;
            ResourceHandler.Host = this;
            wb.OpenExternalLink += ResourceHandler.WebControlLinkClicked;
            wb.ResourceRequest += ResourceHandler.WebControlResourceRequest;
            wb.LoadHTML(Html);
